...
/*
  const memoIndex = useMemo(() => {
    setIndex(props.sizes.length) //編集画面でindexの初期値が0だが、編集の時は既にsizeが３つ入っていますとなったら
  }, [props.sizes.length]); //新規追加の時は３から始めたいので、lengthが変わった時はsetIndexを入れてねという意味
*/
